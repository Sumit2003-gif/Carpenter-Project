  ...
  return (
    ...
    >
      ...
      <motion.div className="lg:col-span-2" variants={itemVariants}>
        ...
        <p className="text-gray-500 mb-6 sm:mb-8 italic">Posted on {blog.date}</p>
        <img
          src={blog.image}
          alt={blog.title}
        ...
        <p className="text-gray-700 text-base sm:text-lg leading-relaxed tracking-wide">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam nec nunc non est
          feugiat suscipit. Sed vitae massa eget libero dignissim volutpat. Integer non
          ante nec justo bibendum gravida. Duis sodales tellus sed urna tincidunt, eu
          feugiat lorem euismod.
        </p>
      ...
      <motion.div className="space-y-8" variants={itemVariants}>
        <h2 className="text-2xl font-semibold mb-6 border-b border-gray-300 pb-3 text-gray-900">Related Blogs</h2>
