...
const FlooringSection = () => {
  const stats = [
    { number: "125+", label: "Materials Available" },
    { number: "97+", label: "Complete Project" },
    { number: "137+", label: "Total Manpower" },
    { number: "16+", label: "Years Experiences" },
  ];
    ...
    >
      <div className="flex flex-col md:flex-row justify-between items-start gap-12 md:gap-16">
        ...
        <motion.div className="md:w-1/2" variants={contentVariants}>
          <p className="text-[#c58b3c] tracking-widest text-sm mb-3">HOW WE WORK</p>
